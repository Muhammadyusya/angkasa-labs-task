...
renderHeader('Pengaturan Akun');
?>

<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 sm:mb-8 min-w-0">
  <div class="flex-1 min-w-0">
    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight truncate">Pengaturan Akun</h1>
    <p class="text-sm text-slate-500 mt-2 truncate">Pusat kendali identitas dan keamanan sesi pengguna.</p>
  </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start min-w-0 pb-10">
    ...
    <div class="lg:col-span-7 flex flex-col gap-6">
        <div class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
            ...
            <form method="POST" action="pengaturan.php" class="flex flex-col gap-5">
